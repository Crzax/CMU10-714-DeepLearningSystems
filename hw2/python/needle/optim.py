    ...
    def step(self):
        ...
        for param in self.params:
          ...
          if param not in self.u:
            self.u[param] = ndl.init.zeros(*param.shape, device=param.device, dtype=param.dtype).data
    ...
    def step(self):
        ...
        for param in self.params:
          ...
          if param not in self.m:
            self.m[param] = ndl.init.zeros(*param.shape,device=param.device,dtype=param.dtype).data
          if param not in self.v:
            self.v[param] = ndl.init.zeros(*param.shape,device=param.device,dtype=param.dtype).data
