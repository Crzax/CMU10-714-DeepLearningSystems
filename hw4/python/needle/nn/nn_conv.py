...
from needle.init.init_basic import rand
import numpy as np
...
class Conv(Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, bias=True, device=None, dtype="float32"):
        ...
        self.bias = Parameter(rand(out_channels,low=-interval, high=interval, device=device,dtype=dtype,requires_grad=True)) if bias else None
        ### END YOUR SOLUTION
